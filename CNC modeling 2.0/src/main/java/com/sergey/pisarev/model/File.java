...
public class File {
    ...
    public static java.io.File filePath;
    ...
    public static String getFileContent() {
        ...
        try {
            FileInputStream program = new FileInputStream(filePath);
    ...
    private static void writer(java.io.File file,String text,Charset cs) throws IOException {
        Writer writer;
        writer = Files.newBufferedWriter(file.toPath(), cs);
        writer.write(text);
        writer.close();
    }
